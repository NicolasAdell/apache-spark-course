...
def main():
    ...
    spark = SparkSession.builder.config("spark.sql.warehouse.dir", "file:///C:/temp").appName("TopURLs").getOrCreate()
    ...
    endpointCountsSorted = endpointCounts.orderBy(func.col("count").desc())
